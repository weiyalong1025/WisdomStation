...
import com.winsion.wisdomstation.grid.adapter.BluetoothPointAdapter;
import com.winsion.wisdomstation.grid.adapter.PatrolPlanAdapter;
import com.winsion.wisdomstation.grid.entity.BluetoothPoint;
...
public class PatrolPlanFragment extends BaseFragment implements PatrolPlanContract.View, AdapterView.OnItemClickListener, BluetoothAdapter.LeScanCallback {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_bluetooth:
                ...
                inflate.measure(0, 0);
                int suggestMaxHeight = CommonUtils.getSuggestMaxHeight(mContext, inflate.getMeasuredHeight());
    ...
    public void getPatrolPlanDataSuccess(List<PatrolTaskEntity> patrolPlanDate) {
        ...
        if (patrolPlanDate.size() == 0) {
            ...
            tvDate.setText(data + getString(R.string.patrol_plan));
