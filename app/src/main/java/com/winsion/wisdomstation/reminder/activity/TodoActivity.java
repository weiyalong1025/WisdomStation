...
public class TodoActivity extends BaseActivity implements TodoContract.View {
    ...
    private void showDatePicker() {
        // 隐藏键盘
        CommonUtils.hideKeyboard(etDesc);
        ...
        TimePickerView datePickerView = CommonUtils.getMyTimePickerBuilder(mContext, listener)
    ...
    private void showTimePicker() {
        ...
        TimePickerView timePickerView = CommonUtils.getMyTimePickerBuilder(mContext, listener)
