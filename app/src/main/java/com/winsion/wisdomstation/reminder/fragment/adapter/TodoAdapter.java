package com.winsion.wisdomstation.reminder.fragment.adapter;
...
public class TodoAdapter extends CommonAdapter<TodoEntity> {
    ...
    public interface OnButtonClickListener {
        void onButtonClick(TodoEntity todoEntity);
    }
                        ...
                        .setPositiveButton(getString(R.string.confirm),
                                (DialogInterface dialog, int which) -> {
                                    if (onButtonClickListener != null) {
                                        onButtonClickListener.onButtonClick(mDatas.get(position));
                                    }
                                    dialog.cancel();
                                })
                        .create()
