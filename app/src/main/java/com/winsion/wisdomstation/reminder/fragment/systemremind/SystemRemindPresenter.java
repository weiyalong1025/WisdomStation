...
import com.winsion.wisdomstation.reminder.entity.MessageHandling;
...
public class SystemRemindPresenter implements SystemRemindContract.Presenter {
    ...
    public SystemRemindPresenter(SystemRemindContract.View view) {
        this.mView = view;
    }
     ...
     */
    @Override
    public void handleReminds(List<String> remindIds, int handleType) {
        MessageHandling messageHandling = new MessageHandling();
        messageHandling.setId(remindIds);
        ...
        NetDataSource.post(getClass(), Urls.MESSAGE_HANDLING, messageHandling, 0, new ResponseListener<String>() {
            ...
            public void onSuccess(String result) {
                mView.handleRemindsSuccess(handleType);
            }
