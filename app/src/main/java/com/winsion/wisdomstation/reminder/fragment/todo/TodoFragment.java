...
import com.winsion.wisdomstation.reminder.activity.TodoActivity;
...
import com.winsion.wisdomstation.reminder.fragment.adapter.TodoAdapter;
...
public class TodoFragment extends BaseFragment implements TodoContract.View, AdapterView.OnItemClickListener {
    ...
    /**
     * 该事件由{@link com.winsion.wisdomstation.reminder.receiver.TodoReceiver}发出
     *
     * @param event
     */
