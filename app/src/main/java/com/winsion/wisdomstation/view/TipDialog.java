    ...
    public static class Builder {
        ...
        public TipDialog create() {
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(mContext.getResources().getDimensionPixelSize(R.dimen.d32));
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = mContext.getResources().getDimensionPixelSize(R.dimen.d12);
                }
                ...
                tipView.setTextColor(ContextCompat.getColor(mContext, R.color.white1));
                tipView.setTextSize(TypedValue.COMPLEX_UNIT_PX, mContext.getResources().getDimension(R.dimen.s14));
