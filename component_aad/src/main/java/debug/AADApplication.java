...
import com.winsion.component.aad.BuildConfig;
 ...
 * 到发组件DEBUG版本Application
 */

public class AADApplication extends Application {
    ...
    public void onCreate() {
        ...
        // 初始化网络库
        NetDataSource.init(this, BuildConfig.DEBUG, getString(R.string.aad_app_name));
    ...
    private void initLog() {
        ...
        String logTag = getString(R.string.aad_app_name);
