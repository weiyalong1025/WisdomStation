...
//                requestCode, intent, FLAG);
     ...
     * 普通的通知
     */
    public void notifyNormalSingleLine(PendingIntent pendingIntent, int smallIcon,
     ...
     */
    public void notifyNormalMoreLine(PendingIntent pendingIntent, int smallIcon, String ticker, int MessageID,
                                     String title, String content, boolean sound, boolean vibrate, boolean lights) {

        final int sdk = Build.VERSION.SDK_INT;
        if (sdk < Build.VERSION_CODES.JELLY_BEAN) {
            notifyNormalSingleLine(pendingIntent, smallIcon, ticker, title, content, sound, vibrate, lights);
        } else {
     ...
     * 里面有两个按钮的通知
     */
    public void notifyButton(int smallIcon, int leftBtnIcon, String leftText, PendingIntent leftPendIntent,
    ...
    public void notifyHeadUp(PendingIntent pendingIntent, int smallIcon, int largeIcon,
                             ...
                             String rightText, PendingIntent rightPendingIntent, boolean sound,
