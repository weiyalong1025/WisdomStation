...
public class RecordAudioActivity extends BaseActivity {
    ...
    protected int setContentView() {
        ...
        return R.layout.media_activity_record_audio;
    }
    ...
    public void onClick(View view) {
        if (!isRecording) {
            ...
            try {
                ...
                recorder.start();
                isRecording = true;
                btnRecord.setImageResource(R.drawable.media_btn_record_reverse);
            ...
            stop();
            btnRecord.setImageResource(R.drawable.media_btn_record);
        }
    }
