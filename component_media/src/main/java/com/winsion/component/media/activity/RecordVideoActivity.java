package com.winsion.component.media.activity;
...
public class RecordVideoActivity extends BaseActivity {
    ...
    protected int setContentView() {
        return R.layout.media_activity_record_video;
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.iv_shutter) {
            if (!isPressed) {
                isPressed = true;
                mShutter.setImageResource(R.drawable.media_btn_record_reverse);
            } else {
                isPressed = false;
                mShutter.setImageResource(R.drawable.media_bg_start_record);
            }
            if (mIsRecording) {
                stopRecording();
            } else {
