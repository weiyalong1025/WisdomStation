package com.winsion.component.media.adapter;
...
public class RecordAdapter extends CommonAdapter<LocalRecordEntity> {
    ...
    public RecordAdapter(Context context, List<LocalRecordEntity> data) {
        super(context, R.layout.media_item_record, data);
    }
    ...
    private void convertMediaData(ViewHolder viewHolder, LocalRecordEntity localRecordEntity) {
        switch (localRecordEntity.getFileType()) {
            ...
            case FileType.PICTURE:
                viewHolder.setImageResource(R.id.iv_file_type, R.drawable.media_ic_picture);
                break;
            // 视频
            case FileType.VIDEO:
                viewHolder.setImageResource(R.id.iv_file_type, R.drawable.media_ic_video);
                break;
            // 音频
            case FileType.AUDIO:
                viewHolder.setImageResource(R.id.iv_file_type, R.drawable.media_ic_audio);
                break;
        }
        ...
        switch (fileStatus) {
            ...
            case FileStatus.NO_DOWNLOAD:
                ...
                viewHolder.setImageResource(R.id.iv_status, R.drawable.media_ic_failed);
                break;
            case FileStatus.UPLOADING:
            case FileStatus.DOWNLOADING:
            ...
            case FileStatus.SYNCHRONIZED:
                viewHolder.setVisible(R.id.iv_status, true);
                viewHolder.setVisible(R.id.cpb_status, false);
                viewHolder.setImageResource(R.id.iv_status, R.drawable.media_ic_synchronized);
                break;
        }
