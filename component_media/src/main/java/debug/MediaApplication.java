...
import com.winsion.component.media.BuildConfig;
...
public class MediaApplication extends Application {
    ...
    public void onCreate() {
        ...
        // 初始化网络库
        NetDataSource.init(this, BuildConfig.DEBUG, getString(R.string.media_app_name));
    ...
    private void initLog() {
        ...
        String logTag = getString(R.string.media_app_name);
