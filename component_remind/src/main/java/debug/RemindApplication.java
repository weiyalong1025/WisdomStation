...
import com.winsion.component.remind.BuildConfig;
...
public class RemindApplication extends Application {
    ...
    public void onCreate() {
        ...
        // 初始化网络库
        NetDataSource.init(this, BuildConfig.DEBUG, getString(R.string.remind_app_name));
    ...
    private void initLog() {
        ...
        String logTag = getString(R.string.remind_app_name);
