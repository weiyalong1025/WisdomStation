...
import com.winsion.component.scene.BuildConfig;
...
public class SceneApplication extends Application {
    ...
    public void onCreate() {
        ...
        // 初始化网络库
        NetDataSource.init(this, BuildConfig.DEBUG, getString(R.string.scene_app_name));
    ...
    private void initLog() {
        ...
        String logTag = getString(R.string.scene_app_name);
