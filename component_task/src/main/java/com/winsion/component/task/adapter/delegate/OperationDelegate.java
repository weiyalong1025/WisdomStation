...
public class OperationDelegate implements ItemViewDelegate<TaskEntity> {
    private Context mContext;
    private List<TaskEntity> mData;

    public OperationDelegate(Context context, List<TaskEntity> data) {
    ...
    public int getItemViewLayoutId() {
        return R.layout.task_item_operation;
    }
