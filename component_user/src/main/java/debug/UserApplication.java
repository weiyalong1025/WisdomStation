...
import com.winsion.component.user.BuildConfig;
...
public class UserApplication extends Application {
    ...
    public void onCreate() {
        ...
        // 初始化网络库
        NetDataSource.init(this, BuildConfig.DEBUG, getString(R.string.user_app_name));
    ...
    private void initLog() {
        ...
        String logTag = getString(R.string.user_app_name);
